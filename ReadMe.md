...
2026年2月起，已开始v2版本的开发工作，计划于2026年完成。计划的改造内容包括：

### Core
- 更加全面地采用依赖注入方式实现服务的调用
- 新增Postgres等服务型数据库的支持
- 优化整体层次架构

### Web项目
- 不再基于Furion框架，改为基于原生ASP.NET Core 10
- 取消Host，改为由WebAPI项目直接调用服务
- 优化接口定义

### 客户端项目
- 使用Avalonia重构，实现客户端的跨平台
